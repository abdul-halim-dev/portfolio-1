...
const Footer = () => {
  return (
    ...
    <div className=" flex items-center justify-center gap-4  " >
            ...
            <a className=" text-common text-lg hover:text-active duration-500 " href="#"><FaTwitter/> </a>
            <a className=" text-common text-lg hover:text-active duration-500 " href="#"><FaInstagram/> </a>
            <a className=" text-common text-lg hover:text-active duration-500 " href="#"><FaLinkedinIn/> </a>
