  ...
  return (
    ...
    <section id="service" className={ServiceCont}>
      ...
      <div className={serviceheaders}>
        <h1 className=" font-bold text-4xl text-hoverout uppercase " > My Services</h1>
      ...
      <div className={serviceCardWrapper}>
        ...
        <div className={serviceCardStyle}>
          ...
          <div className=" dddd flex items-start justify-center gap-4 flex-col ">
            <h6 className=" font-semibold text-xl text-hoverout ">Responsiveness</h6>
            <p className="   text-[18px] text-para">I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
          </div>
        ...
        <div className={serviceCardStyle}>
          ...
          <div className=" dddd flex items-start justify-center gap-4 flex-col ">
            <h6 className=" font-semibold text-xl text-hoverout ">Different Layout</h6>
            <p className="   text-[18px] text-para">I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
          </div>
        ...
        <div className={serviceCardStyle}>
          ...
          <div className=" dddd flex items-start justify-center gap-4 flex-col ">
            <h6 className=" font-semibold text-xl text-hoverout ">Make it Simple</h6>
            <p className="   text-[18px] text-para">I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
          </div>
        ...
        <div className={serviceCardStyle}>
          ...
          <div className=" dddd flex items-start justify-center gap-4 flex-col ">
            <h6 className=" font-semibold text-xl text-hoverout ">Testing for Perfection</h6>
            <p className="   text-[18px] text-para">I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
          </div>
        ...
        <div className={serviceCardStyle}>
          ...
          <div className=" dddd flex items-start justify-center gap-4 flex-col ">
            <h6 className=" font-semibold text-xl text-hoverout ">Advanced Options</h6>
            <p className="   text-[18px] text-para">I design and develop services for customers of all sizes, specializing in creating stylish, modern websites.</p>
          </div>
